...
// [a, alpha, d]
Arm_State_t g_arm_state = { .joints[0].dh_params = {0, M_PI / 2, 0.1},
                            .joints[1].dh_params = {0.3, 0, 0, M_PI / 2},
                            .joints[2].dh_params = {0.3, 0, 0, 0},
                            .joints[3].dh_params = {0, M_PI /2, 0.1},
                            .joints[4].dh_params = {0, -1 * M_PI /2, 0.1},
